...
variable "fsx_windows_throughput_time_aggregator" {
  description = "Monitor aggregator for FSX for Windows throughput [available values: sum, min, max or avg]"
  type        = string
  default     = "sum"
}
...
variable "fsx_windows_throughput_threshold_critical" {
  default     = 15000000
  description = "FSX for Windows throughput critical threshold in Bytes"
}

variable "fsx_windows_throughput_threshold_warning" {
  default     = 12000000
  description = "FSX for Windows throughput warning threshold in Bytes"
}
